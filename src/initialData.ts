...
export const getInitialMatches = (): Match[] => {
  ...
  // --- 5. PARADE & CHEERLEADER (พาเหรดและประกวดกองเชียร์) ---
  // ที่ 1, 2, 3 — บันทึกผลผ่าน drawLots key: "parade_result_พาเหรดและประกวดกองเชียร์"
  matches.push({
    id: "parade_result_1",
    sport: "parade",
    category: "พาเหรดและประกวดกองเชียร์",
    gender: "ผสม",
    group: "",
    round: "รอบชิงชนะเลิศ",
    court: "สนามกีฬา",
